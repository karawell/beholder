...
function QuantityInput(props) {
    ...
    function onCalcClick(event) {
        ...
        const qty = quoteAmount / parseFloat(props.price);
        if (!qty) return;
    ...
    const quantityInput = useMemo(() => (
        <div className="form-group">
            ...
            <div className="input-group">
                ...
                <input id={props.id} type="number" ref={inputQuantity} className="form-control" placeholder={props.symbol.minLotSize} onChange={props.onChange} />
            </div>
        </div>
